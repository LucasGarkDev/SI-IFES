...
while maisUmAluno == "S" :
    while cont <= 10 :
        ...
        while gab1 != "A" and gab1 != "B" and gab1 != "C" and gab1 != "D" and gab1 != "E":
            ...
            gab1 = str(input("Qual foi o gabarito (A/B/C/D/E) da questão 1: ")).upper()
        alternativaMarcada = str(input("Digite a alternativa que o aluno marcou: ")).upper()
        if cont == 1 :
            cont = cont + 1
...
print("O numero de alunos que usaram o sistema foi: %d"%contAlunos)
mediaNotas = somaNotas / contAlunos
print("A media das notas dessa turma foi: %.2f"%mediaNotas)
